                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-2">
                                ...
                                @error('cid')<span class="small text-danger">{{ $message }}</span>@enderror
                            </div>
                            <div class="form-group col-lg-3">
                                <label for="notes">@lang('messages.notes')</label>
                                <input autocomplete="off" type="text" wire:model.lazy="notes" id="notes"
                                       class="form-control @error('notes') is-invalid @enderror">
                                @error('notes')<span class="small text-danger">{{ $message }}</span>@enderror
                            </div>
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <div class="form-check">
                                    <input tabindex="-1" class="form-check-input" type="checkbox"
                                           wire:model.lazy="active" id="active" checked>
                            ...
                            @foreach($phones as $i=>$phone)
                                <tr>
                                    ...
                                    <td>
                                        @if(count($phones) > 1)
                                            @if($phones[$i]['id'] == null)
                                                <button wire:click.prevent="delete_row('phone',{{$i}})" type="submit"
                            ...
                            @foreach($addresses as $i=>$address)
                                <tr>
                                    <td class="align-middle text-center">
                                        {{$loop->iteration}}
                                        <input autocomplete="off" type="text" wire:model="addresses.{{$i}}.id"
                                               class="d-none form-control @error('addresses.'.$i.'.id') is-invalid @enderror">
                                    </td>
                                    <td>
                                        <select wire:model="addresses.{{$i}}.area_id"
                                                class="form-control @error('addresses.'.$i.'.area_id') is-invalid @enderror">
                                    ...
                                    <td>
                                        <input autocomplete="off" type="text" wire:model="addresses.{{$i}}.block"
                                               class="form-control @error('addresses.'.$i.'.block') is-invalid @enderror">
                                    </td>
                                    <td>
                                        <input autocomplete="off" type="text" wire:model="addresses.{{$i}}.street"
                                               class="form-control @error('addresses.'.$i.'.street') is-invalid @enderror">
                                    </td>
                                    <td>
                                        <input autocomplete="off" type="text" wire:model="addresses.{{$i}}.jadda"
                                               class="form-control @error('addresses.'.$i.'.jadda') is-invalid @enderror">
                                    </td>
                                    <td>
                                        <input autocomplete="off" type="text" wire:model="addresses.{{$i}}.building"
                                               class="form-control @error('addresses.'.$i.'.building') is-invalid @enderror">
                                    </td>

                                    <td>
                                        <input autocomplete="off" type="text" wire:model="addresses.{{$i}}.floor"
                                               class="form-control @error('addresses.'.$i.'.floor') is-invalid @enderror">
                                    </td>

                                    <td>
                                        <input autocomplete="off" type="text" wire:model="addresses.{{$i}}.apartment"
                                               class="form-control @error('addresses.'.$i.'.apartment') is-invalid @enderror">
                                    </td>

                                    <td>
                                        <input autocomplete="off" type="text" wire:model="addresses.{{$i}}.notes"
                                               class="form-control @error('addresses.'.$i.'.notes') is-invalid @enderror">
                                    </td>
                                    <td class="align-middle text-center">
                                        @if(count($addresses) > 1)
                                            @if($addresses[$i]['id'] == null)
                                                <button tabindex="-1" wire:click.prevent="delete_row('address',{{$i}})"
                                                        type="submit"
                                                        class="text-danger btn btn-sm">
                                                    <svg style="width: 15px;height: 15px">
                                                        <use
